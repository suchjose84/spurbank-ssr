...
@Component({
  selector: 'app-blog15-ghostbusters-frozen-empire',
  templateUrl: './blog15-ghostbusters-frozen-empire.component.html',
  styleUrls: ['./blog15-ghostbusters-frozen-empire.component.css']
})
export class Blog15GhostbustersFrozenEmpireComponent implements OnInit{

  // check 1 - Update title
  pageTitle: string = "Ghostbusters Frozen Empire: Unveiling the Chilling Sequel | Spurbank.info";
  articleTitle: string = "Ghostbusters Frozen Empire: Unveiling the Chilling Sequel";
  articleDescription: string = `Scheduled for release on March 29, 2024, "Ghostbusters: Frozen Empire" stands as the highly anticipated follow-up
  to the 2021 hit, "Ghostbusters: Afterlife." Directed by Gil Kenan, who co-wrote the script with Jason Reitman, the
  film marks the fifth installment in the iconic Ghostbusters franchise.`;
  articleUrl: string = "https://www.spurbank.info/ghostbusters-frozen-empire";
